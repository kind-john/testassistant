...
public class SharedNetSwitchOn extends TestItemBase {
    public static final int ID = 8;
    private static final String TITLE = "Shared Net Switch On";
    private static final String TAG = "SharedNetSwitchOn";

    public SharedNetSwitchOn() {
        super();
    ...
    public SharedNetSwitchOn(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "SharedNetSwitchOn doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("SharedNetSwitchOn settings")
                .setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(SharedNetSwitchOn.this);
                            }
                        }
                    }
                })

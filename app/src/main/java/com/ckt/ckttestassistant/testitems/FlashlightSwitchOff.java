...
public class FlashlightSwitchOff extends TestItemBase {
    public static final int ID = 24;
    private static final String TITLE = "Flashlight Switch Off";
    private static final String TAG = "FlashlightSwitchOff";

    public FlashlightSwitchOff() {
        super();
    ...
    public FlashlightSwitchOff(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "FlashlightSwitchOff doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("FlashlightSwitchOff settings")
                .setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(FlashlightSwitchOff.this);
                            }
                        }
                    }
                })

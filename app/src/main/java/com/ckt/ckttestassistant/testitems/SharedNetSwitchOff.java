...
public class SharedNetSwitchOff extends TestItemBase {
    public static final int ID = 9;
    private static final String TITLE = "Shared Net Switch Off";
    private static final String TAG = "SharedNetSwitchOff";

    private int mDelay = 0;

    public SharedNetSwitchOff() {
        super();
    ...
    public SharedNetSwitchOff(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "SharedNetSwitchOff doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("SharedNetSwitchOff settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(SharedNetSwitchOff.this);
                            }
                        }
                    }
                })

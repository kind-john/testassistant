...
public class ScreenSaverSwitchOn extends TestItemBase {
    public static final int ID = 19;
    private static final String TITLE = "Screen Saver Switch On";
    private static final String TAG = "ScreenSaverSwitchOn";

    public ScreenSaverSwitchOn() {
        super();
    ...
    public ScreenSaverSwitchOn(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "ScreenSaverSwitchOn doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("ScreenSaverSwitchOn settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(ScreenSaverSwitchOn.this);
                            }
                        }
                    }
                })

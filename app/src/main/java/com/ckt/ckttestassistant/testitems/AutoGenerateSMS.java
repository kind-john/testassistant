...
public class AutoGenerateSMS extends TestItemBase {
    public static final int ID = 81;
    private static final String TITLE = "Auto Generate SMS";
    private static final String TAG = "AutoGenerateSMS";

    public AutoGenerateSMS() {
        super();
    ...
    public AutoGenerateSMS(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "AutoGenerateSMS doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("AutoGenerateSMS settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(AutoGenerateSMS.this);
                            }
                        }
                    }
                })

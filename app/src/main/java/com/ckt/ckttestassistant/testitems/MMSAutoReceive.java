...
public class MMSAutoReceive extends TestItemBase {
    public static final int ID = 45;
    private static final String TITLE = "MMS Auto Receive";
    private static final String TAG = "MMSAutoReceive";

    public MMSAutoReceive() {
        super();
    ...
    public MMSAutoReceive(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "MMSAutoReceive doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("MMSAutoReceive settings")
                .setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(MMSAutoReceive.this);
                            }
                        }
                    }
                })

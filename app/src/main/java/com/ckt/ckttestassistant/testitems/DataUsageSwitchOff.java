...
public class DataUsageSwitchOff extends TestItemBase {
    ...
    public DataUsageSwitchOff(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "DataUsageSwitchOff doExecute");
        try {
            ...
            if(status){
                setMethod.invoke(mTelephonyManager, false);
            }
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(DataUsageSwitchOff.this);
                            }
                        }
                    }
                })

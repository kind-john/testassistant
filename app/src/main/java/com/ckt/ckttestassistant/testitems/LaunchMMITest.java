...
public class LaunchMMITest extends TestItemBase {
    public static final int ID = 30;
    private static final String TITLE = "Launch MMITest";
    private static final String TAG = "LaunchMMITest";
    private static final String TARGET_PACKAGE_NAME = "cn.ckt.factorymode";
    private static final String TARGET_ACTIVITY_NAME = "cn.ckt.factorymode.CktFactoryModeActivity";

    public LaunchMMITest() {
        super();
    ...
    public LaunchMMITest(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "LaunchMMITest doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchMMITest settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchMMITest.this);
                            }
                        }
                    }
                })

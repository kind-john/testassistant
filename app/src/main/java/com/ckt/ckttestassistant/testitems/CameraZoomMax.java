...
public class CameraZoomMax extends TestItemBase {
    public static final int ID = 84;
    private static final String TITLE = "Camera Zoom Max";
    private static final String TAG = "CameraZoomMax";

    public CameraZoomMax() {
        super();
    ...
    public CameraZoomMax(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "CameraZoomMax doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("CameraZoomMax settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(CameraZoomMax.this);
                            }
                        }
                    }
                })

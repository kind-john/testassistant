...
public class TorchSwitchOn extends TestItemBase {
    public static final int ID = 25;
    private static final String TITLE = "Torch Switch On";
    private static final String TAG = "TorchSwitchOn";

    public TorchSwitchOn() {
        super();
    ...
    public TorchSwitchOn(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "TorchSwitchOn doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("TorchSwitchOn settings")
                .setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(TorchSwitchOn.this);
                            }
                        }
                    }
                })

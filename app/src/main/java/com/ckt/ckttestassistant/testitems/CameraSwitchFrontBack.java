...
public class CameraSwitchFrontBack extends TestItemBase {
    public static final int ID = 63;
    private static final String TITLE = "Camera Switch FrontBack";
    private static final String TAG = "CameraSwitchFrontBack";
    ...
    public CameraSwitchFrontBack(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "CameraSwitchFrontBack doExecute");
            ...
            public void run() {
                try{
                    ...
                    inst.sendPointerSync(MotionEvent.obtain(SystemClock.uptimeMillis(),
                            SystemClock.uptimeMillis(), MotionEvent.ACTION_DOWN, 670, 910, 0));
                    inst.sendPointerSync(MotionEvent.obtain(SystemClock.uptimeMillis(),
                            SystemClock.uptimeMillis(), MotionEvent.ACTION_UP, 670, 910, 0));
    ...
    public void saveResult() {
        LogUtils.d(TAG, "CameraSwitchFrontBack saveResult");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("CameraSwitchFrontBack settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(CameraSwitchFrontBack.this);
                            }
                        }
                    }
                })

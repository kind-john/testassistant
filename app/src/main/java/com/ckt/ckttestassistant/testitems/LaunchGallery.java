...
public class LaunchGallery extends TestItemBase {
    public static final int ID = 35;
    private static final String TITLE = "Launch Gallery";
    private static final String TAG = "LaunchGallery";
    private static final String TARGET_PACKAGE_NAME = "com.android.gallery3d";
    private static final String TARGET_ACTIVITY_NAME = "com.android.gallery3d.app.GalleryActivity";
    ...
    public LaunchGallery(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "LaunchGallery doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchGallery settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchGallery.this);
                            }
                        }
                    }
                })

...
public class LaunchDialPlate extends TestItemBase {
    public static final int ID = 28;
    private static final String TITLE = "Launch DialPlate";
    private static final String TAG = "LaunchDialPlate";
    private static final String TARGET_PACKAGE_NAME = "com.android.dialer";
    private static final String TARGET_ACTIVITY_NAME = "com.android.dialer.DialtactsActivity";

    public LaunchDialPlate() {
        super();
    ...
    public LaunchDialPlate(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "LaunchDialPlate doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchDialPlate settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchDialPlate.this);
                            }
                        }
                    }
                })

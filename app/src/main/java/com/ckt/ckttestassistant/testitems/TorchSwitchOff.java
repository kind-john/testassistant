...
public class TorchSwitchOff extends TestItemBase {
    public static final int ID = 26;
    private static final String TITLE = "Torch Switch Off";
    private static final String TAG = "TorchSwitchOff";

    public TorchSwitchOff() {
        super();
    ...
    public TorchSwitchOff(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "TorchSwitchOff doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("TorchSwitchOff settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(TorchSwitchOff.this);
                            }
                        }
                    }
                })

...
public class LaunchTwitter extends TestItemBase {
    public static final int ID = 39;
    private static final String TITLE = "Launch Twitter";
    private static final String TAG = "LaunchTwitter";
    private static final String TARGET_PACKAGE_NAME = "com.twitter.android";
    private static final String TARGET_ACTIVITY_NAME = "com.twitter.android.StartActivity";

    public LaunchTwitter() {
        super();
    ...
    public LaunchTwitter(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "LaunchTwitter doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchTwitter settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchTwitter.this);
                            }
                        }
                    }
                })

...
public class ScreenSaverSwitchOff extends TestItemBase {
    public static final int ID = 20;
    private static final String TITLE = "Screen Saver Switch Off";
    private static final String TAG = "ScreenSaverSwitchOff";

    public ScreenSaverSwitchOff() {
        super();
    ...
    public ScreenSaverSwitchOff(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "ScreenSaverSwitchOff doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("ScreenSaverSwitchOff settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(ScreenSaverSwitchOff.this);
                            }
                        }
                    }
                })

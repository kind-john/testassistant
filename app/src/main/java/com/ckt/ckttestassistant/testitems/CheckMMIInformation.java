...
public class CheckMMIInformation extends TestItemBase {
    public static final int ID = 56;
    private static final String TITLE = "Check MMI Information";
    private static final String TAG = "CheckMMIInformation";

    public CheckMMIInformation() {
        super();
    ...
    public CheckMMIInformation(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "CheckMMIInformation doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("CheckMMIInformation settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(CheckMMIInformation.this);
                            }
                        }
                    }
                })

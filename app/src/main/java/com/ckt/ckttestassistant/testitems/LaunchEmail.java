...
public class LaunchEmail extends TestItemBase {
    public static final int ID = 33;
    private static final String TITLE = "Launch Email";
    private static final String TAG = "LaunchEmail";
    private static final String TARGET_PACKAGE_NAME = "com.android.email";
    private static final String TARGET_ACTIVITY_NAME = "com.android.email.activity.Welcome";
    ...
    public LaunchEmail(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "LaunchEmail doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchEmail settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchEmail.this);
                            }
                        }
                    }
                })

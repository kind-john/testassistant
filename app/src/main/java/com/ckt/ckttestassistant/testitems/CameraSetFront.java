...
public class CameraSetFront extends TestItemBase {
    public static final int ID = 72;
    private static final String TITLE = "Camera Set Front";
    private static final String TAG = "CameraSetFront";

    private int mDelay = 0;

    public CameraSetFront() {
        super();
    ...
    public CameraSetFront(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "CameraSetFront doExecute");
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(CameraSetFront.this);
                            }
                        }
                    }
                })

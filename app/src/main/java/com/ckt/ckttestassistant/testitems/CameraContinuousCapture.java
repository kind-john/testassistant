...
public class CameraContinuousCapture extends TestItemBase {
    public static final int ID = 87;
    private static final String TITLE = "Camera Continuous Capture";
    private static final String TAG = "CameraContinuousCapture";

    public CameraContinuousCapture() {
        super();
    ...
    public CameraContinuousCapture(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "CameraContinuousCapture doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("CameraContinuousCapture settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(CameraContinuousCapture.this);
                            }
                        }
                    }
                })

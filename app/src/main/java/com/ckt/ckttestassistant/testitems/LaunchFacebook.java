...
public class LaunchFacebook extends TestItemBase {
    public static final int ID = 38;
    private static final String TITLE = "Launch Facebook";
    private static final String TAG = "LaunchFacebook";
    private static final String TARGET_PACKAGE_NAME = "com.facebook.lite";
    private static final String TARGET_ACTIVITY_NAME = "com.facebook.lite.MainActivity";
    ...
    public LaunchFacebook(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "LaunchFacebook doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchFacebook settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchFacebook.this);
                            }
                        }
                    }
                })

...
public class LaunchChrome extends TestItemBase {
    public static final int ID = 36;
    private static final String TITLE = "Launch Chrome";
    private static final String TAG = "LaunchChrome";
    private static final String TARGET_PACKAGE_NAME = "com.android.chrome";
    private static final String TARGET_ACTIVITY_NAME = "com.google.android.apps.chrome.Main";
    ...
    public LaunchChrome(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "LaunchChrome doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchChrome settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchChrome.this);
                            }
                        }
                    }
                })

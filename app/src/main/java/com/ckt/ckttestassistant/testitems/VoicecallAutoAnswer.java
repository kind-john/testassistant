...
public class VoicecallAutoAnswer extends TestItemBase {
    public static final int ID = 41;
    private static final String TITLE = "Voicecall Auto Answer";
    private static final String TAG = "VoicecallAutoAnswer";

    public VoicecallAutoAnswer() {
        super();
    ...
    public VoicecallAutoAnswer(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "VoicecallAutoAnswer doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("VoicecallAutoAnswer settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(VoicecallAutoAnswer.this);
                            }
                        }
                    }
                })

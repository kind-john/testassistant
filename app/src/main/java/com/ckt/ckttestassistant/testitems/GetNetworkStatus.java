...
public class GetNetworkStatus extends TestItemBase {
    public static final int ID = 2;
    private static final String TITLE = "Get Network Status";
    private static final String TAG = "GetNetworkStatus";
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("GetNetworkStatus settings")
                .setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(GetNetworkStatus.this);
                            }
                        }
                    }
                })

...
public class VoicecallAutoDial extends TestItemBase {
    public static final int ID = 40;
    private static final String TITLE = "Voicecall Auto Dial";
    private static final String TAG = "VoicecallAutoDial";

    public VoicecallAutoDial() {
        super();
    ...
    public VoicecallAutoDial(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "VoicecallAutoDial doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("VoicecallAutoDial settings")
                .setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(VoicecallAutoDial.this);
                            }
                        }
                    }
                })

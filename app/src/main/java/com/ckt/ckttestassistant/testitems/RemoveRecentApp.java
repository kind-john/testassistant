...
public class RemoveRecentApp extends TestItemBase {
    public static final int ID = 1;
    private static final String TITLE = "Remove Recent Apps";
    private static final String TAG = "RemoveRecentApp";

    public RemoveRecentApp() {
        super();
    ...
    public RemoveRecentApp(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("RemoveRecentApp settings")
                .setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(RemoveRecentApp.this);
                            }
                        }
                    }
                })

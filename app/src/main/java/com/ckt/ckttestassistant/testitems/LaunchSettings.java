...
public class LaunchSettings extends TestItemBase {
    public static final int ID = 31;
    private static final String TITLE = "Launch Settings";
    private static final String TAG = "LaunchSettings";
    private static final String TARGET_PACKAGE_NAME = "com.android.settings";
    private static final String TARGET_ACTIVITY_NAME = "com.android.settings.Settings";
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchSettings settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchSettings.this);
                            }
                        }
                    }
                })

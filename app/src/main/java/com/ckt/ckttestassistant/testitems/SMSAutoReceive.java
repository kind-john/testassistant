...
public class SMSAutoReceive extends TestItemBase {
    public static final int ID = 43;
    private static final String TITLE = "SMS Auto Receive";
    private static final String TAG = "SMSAutoReceive";

    public SMSAutoReceive() {
        super();
    ...
    public SMSAutoReceive(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "SMSAutoReceive doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("SMSAutoReceive settings")
                .setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(SMSAutoReceive.this);
                            }
                        }
                    }
                })

...
public class CameraEnterPreview extends TestItemBase {
    public static final int ID = 74;
    private static final String TITLE = "Camera Enter Preview";
    private static final String TAG = "CameraEnterPreview";

    private int mDelay = 0;

    public CameraEnterPreview() {
        super();
    ...
    public CameraEnterPreview(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "CameraEnterPreview doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("CameraEnterPreview settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(CameraEnterPreview.this);
                            }
                        }
                    }
                })

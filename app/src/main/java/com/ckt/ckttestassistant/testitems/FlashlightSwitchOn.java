...
public class FlashlightSwitchOn extends TestItemBase {
    public static final int ID = 23;
    private static final String TITLE = "Flashlight Switch On";
    private static final String TAG = "FlashlightSwitchOn";

    private int mDelay = 0;

    public FlashlightSwitchOn() {
        super();
    ...
    public FlashlightSwitchOn(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "FlashlightSwitchOn doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("FlashlightSwitchOn settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(FlashlightSwitchOn.this);
                            }
                        }
                    }
                })

...
public class AutoScreenOff extends TestItemBase {
    public static final int ID = 58;
    private static final String TITLE = "Auto Screen Off";
    private static final String TAG = "AutoScreenOff";

    public AutoScreenOff() {
        super();
    ...
    public AutoScreenOff(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "AutoScreenOff doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("AutoScreenOff settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(AutoScreenOff.this);
                            }
                        }
                    }
                })

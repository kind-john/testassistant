...
public class SimulateVolumeUpKey extends TestItemBase {
    public static final int ID = 50;
    private static final String TITLE = "Simulate Volume Up Key";
    private static final String TAG = "SimulateVolumeUpKey";

    public SimulateVolumeUpKey() {
        super();
    ...
    public SimulateVolumeUpKey(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "SimulateVolumeUpKey doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("SimulateVolumeUpKey settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(SimulateVolumeUpKey.this);
                            }
                        }
                    }
                })

...
public class EnableAllApp extends TestItemBase {
    public static final int ID = 54;
    private static final String TITLE = "Enable All App";
    private static final String TAG = "EnableAllApp";
    ...
    public EnableAllApp(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("EnableAllApp settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(delay >= 0 && times > 0){
                            ...
                            setTimes(times);
                            if(isNeedUpdateXml){
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(EnableAllApp.this);
                            }
                        }
                    }
                })

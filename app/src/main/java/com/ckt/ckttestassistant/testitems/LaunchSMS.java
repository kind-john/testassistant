...
public class LaunchSMS extends TestItemBase {
    public static final int ID = 32;
    private static final String TITLE = "Launch SMS";
    private static final String TAG = "LaunchSMS";
    private static final String TARGET_PACKAGE_NAME = "com.android.messaging";
    private static final String TARGET_ACTIVITY_NAME = "com.android.messaging.ui.conversationlist.ConversationListActivity";
    ...
    public LaunchSMS(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public boolean doExecute(UseCaseManager.ExecuteCallback executeCallback, boolean finish) {
        LogUtils.d(TAG, "LaunchSMS doExecute");
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchSMS settings")
                .setView(v)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchSMS.this);
                            }
                        }
                    }
                })

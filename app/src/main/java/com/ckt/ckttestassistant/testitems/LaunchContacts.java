...
public class LaunchContacts extends TestItemBase {
    public static final int ID = 27;
    private static final String TITLE = "Launch Contacts";
    private static final String TAG = "LaunchContacts";
    private static final String TARGET_PACKAGE_NAME = "com.android.contacts";
    private static final String TARGET_ACTIVITY_NAME = "com.android.contacts.activities.PeopleActivity";
    ...
    public LaunchContacts(Context context) {
        super(context);
        String className = this.getClass().getName();
        setClassName(className);
        setID(ID);
    ...
    public void showPropertyDialog(Context context, final boolean isNeedUpdateXml) {
        ...
        builder.setTitle("LaunchContacts settings")
                .setView(v)
                .setMessage("for test")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (delay >= 0 && times > 0) {
                            ...
                            setTimes(times);
                            if (isNeedUpdateXml) {
                                mUseCaseManager.updateTestItemOfAllUseCaseXml(LaunchContacts.this);
                            }
                        }
                    }
                })
